  ...
  return (
    <div className="pt-[72px] min-h-screen bg-white flex items-center">
      <div className="w-full max-w-md mx-auto px-5 py-16">
        ...
        <h1 className="text-3xl font-display font-medium text-stone-900 tracking-tight">Create Account</h1>
        <p className="mt-3 text-stone-500 font-light text-[15px]">Join Eclection for a personalized experience.</p>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-5">
          <div>
            <label className="block text-[10px] tracking-[0.2em] uppercase text-stone-400 mb-2 font-semibold">Full Name</label>
            <input
              type="text"
              required
              value={fullName}
