    ...
    <AdminLayout>
      <div className="p-6 lg:p-8 max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-xl font-bold text-stone-900">Add New Product</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid lg:grid-cols-3 gap-5">
              ...
              <div className="bg-white rounded-xl border border-stone-200 p-5 space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Describe the product — fabric, fit, style..."
                  ...
                  >
                    ...
                    {uploadingMain ? (
                      ...
                      <>
                        ...
                        <p className="text-sm text-stone-400">Click or drag to upload main image</p>
                        <p className="text-xs text-stone-300">PNG, JPG, WEBP up to 10MB</p>
                      </>
                    )}
                  </label>
                </div>
                  ...
                  <div className="grid grid-cols-3 sm:grid-cols-4 gap-2">
                    ...
                    <label className="aspect-square border-2 border-dashed border-stone-200 hover:border-amber-300 rounded-lg flex flex-col items-center justify-center gap-1 cursor-pointer transition-colors">
                      <input
                        ...
                        className="hidden"
                        onChange={(e) => {
                          if (e.target.files?.length) handleExtraImages(e.target.files);
                          e.target.value = "";
                        }}
                      />
                      {uploadingExtra ? (
                        ...
                        <>
                          ...
                          <p className="text-[10px] text-stone-400 text-center">Add more</p>
                        </>
                      )}
                    </label>
                  </div>
            ...
            <div className="space-y-5">
              ...
              <div className="bg-white rounded-xl border border-stone-200 p-5 space-y-4">
                ...
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <div
                    ...
                    className={`w-11 h-6 rounded-full relative transition-colors cursor-pointer ${form.in_stock ? "bg-amber-500" : "bg-stone-200"}`}
                  >
                ...
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <div
                    ...
                    className={`w-11 h-6 rounded-full relative transition-colors cursor-pointer ${form.featured ? "bg-amber-500" : "bg-stone-200"}`}
                  >
              ...
              >
                {saving ? <><Loader size={15} className="animate-spin" /> Saving...</> : "Save Product"}
              </button>
              <button
                type="button"
                onClick={() => navigate("/admin/products")}
